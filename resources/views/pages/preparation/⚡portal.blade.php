    ...
    <div class="swiper iklan-swiper w-345 h-140 mx-auto overflow-hidden rounded-2xl">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <img src="{{ asset(path: 'assets/images/portal/iklan/Iklan.jpg') }}" <<<<<<< HEAD
                    class="h-full w-full object-cover object-center">
                =======
                class="h-full w-full object-cover object-center">
                >>>>>>> features/filter-portal-2
            </div>

            <div class="swiper-slide">
                <img src="{{ asset('assets/images/portal/iklan/Iklan2.jpg') }}" <<<<<<< HEAD
                    class="h-full w-full object-cover object-center">
                =======
                class="h-full w-full object-cover object-center">
                >>>>>>> features/filter-portal-2
            ...
            <div class="swiper-slide">
                <img src="{{ asset('assets/images/portal/iklan/Iklan3.jpg') }}" <<<<<<< HEAD
                    class="h-full w-full object-cover object-center">
                =======
                class="h-full w-full object-cover object-center">
                >>>>>>> features/filter-portal-2
    ...
    <div class="my-15 flex flex-col">
        ...
        <div class="mt-5 flex justify-center">
            <p class="text-center text-2xl text-[#6B6B6B]">Explore a wide selection of bakery and find the perfect <br>
                =======
            <div class="mt-5 flex justify-center">
                <p class="text-center text-2xl text-[#6B6B6B]">Explore a wide selection of bakery and find the perfect
                    <br>
                    >>>>>>> features/filter-portal-2
                    menu to match your taste
                </p>
            </div>
        </div>
        ...
        <div class="my-15 flex justify-center gap-10">
            <div
                class="group flex gap-3 rounded-xl px-4 py-2 transition duration-200 hover:bg-[#1A76FF] hover:text-white">
                <img class="size-7 group-hover:hidden" src="{{ asset('assets/images/filter-category/all-black.png') }}">
                <img class="hidden size-7 group-hover:block"=======<div class="my-15 flex justify-center gap-10">
                ...
                <div
                    ...
                    <img class="hidden size-7 group-hover:block"=======<div wire:click="setCategory('Cake')"
                ...
                <div
                    ...
                    <img class="hidden size-7 group-hover:block"=======<div wire:click="setCategory('Bread')"
                    ...
                    <img class="{{ $this->cake_type === 'Bread' ? 'hidden' : 'group-hover:hidden' }} size-7"
                        src="{{ asset('assets/images/filter-category/bread-black.png') }}">
                    <img
                        class="{{ $this->cake_type === 'Bread' ? 'block' : 'hidden group-hover:block' }} size-7">>>>>>>
                    features/filter-portal-2
                ...
                <div
                    ...
                    <img class="hidden size-7 group-hover:block"=======<div wire:click="setCategory('Pastry')"
                    ...
                    <img class="{{ $this->cake_type === 'Pastry' ? 'hidden' : 'group-hover:hidden' }} size-7"
                        src="{{ asset('assets/images/filter-category/pastry-black.png') }}">
                    <img
                        class="{{ $this->cake_type === 'Pastry' ? 'block' : 'hidden group-hover:block' }} size-7">>>>>>>
                    features/filter-portal-2
                ...
                <div
                    ...
                    <img class="hidden size-7 group-hover:block"
                        src="{{ asset('assets/images/filter-category/cookies-white.png') }}">
                    <button class="">Cookies</button>
                </div>

                <div class="group flex gap-3 rounded-xl px-4 py-2 hover:bg-[#1A76FF] hover:text-white">
                    <img class="size-7 group-hover:hidden"
                        src="{{ asset('assets/images/filter-category/dessert-black.png') }}">
                    <img class="hidden size-7 group-hover:block"=======<div wire:click="setCategory('Cookies')"
                ...
                <div wire:click="setCategory('Dessert')"
                    ...
                    <img class="{{ $this->cake_type === 'Dessert' ? 'hidden' : 'group-hover:hidden' }} size-7"
                        src="{{ asset('assets/images/filter-category/dessert-black.png') }}">
                    <img
                        class="{{ $this->cake_type === 'Dessert' ? 'block' : 'hidden group-hover:block' }} size-7">>>>>>>
                    features/filter-portal-2
                ...
                <div
                    ...
                    <img class="hidden size-7 group-hover:block"=======<div wire:click="setCategory('Savory')"
                    ...
                    <img class="{{ $this->cake_type === 'Savory' ? 'hidden' : 'group-hover:hidden' }} size-7"
                        src="{{ asset('assets/images/filter-category/savory-black.png') }}">
                    <img
                        class="{{ $this->cake_type === 'Savory' ? 'block' : 'hidden group-hover:block' }} size-7">>>>>>>
                    features/filter-portal-2
