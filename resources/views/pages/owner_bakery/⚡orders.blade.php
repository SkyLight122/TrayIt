            ...
            <div class="flex items-center justify-between px-8">
                ...
                <div class="flex space-x-4">
                    <button class="h-full py-1 mt-4 px-6 rounded-lg bg-white shadow-xl/20">
                        ...
                        <p>Filter by <span class="text-blue-500"> <i>All</i></span></p>
                    </button>
                                ...
                                <tbody class="text-black">
                                    @for ($i = 0; $i < 20; $i++)
                                        <tr class="border-b hover:bg-gray-50 transition text-center">
                                            ...
                                            <td class="py-4 px-6">2025/04/21</td>
                                            <td class="py-4 px-6">Rp0.000.000.000</td>
                                            <td class="py-4 px-6">Master Card</td>
                                            <td class="py-4 px-6 relative" x-data="{
                                                open: false,
