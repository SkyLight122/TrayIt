        ...
        <div class="swiper h-full z-0">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <img src="{{ asset('assets/images/loginregis/Login1.jpg') }}" class="w-full h-194 object-cover">
                </div>

                <div class="swiper-slide">
                    <img src="{{ asset('assets/images/loginregis/Login2.jpg') }}" class="w-full h-194 object-cover">
                </div>

                <div class="swiper-slide">
                    <img src="{{ asset('assets/images/loginregis/Login3.jpg') }}" class="w-full h-194 object-cover">
                </div>
